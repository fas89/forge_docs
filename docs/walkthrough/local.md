...
<CliCast
  ...
  caption="The full local quickstart compressed: install with the [local] extra, scaffold a Bitcoin tracker contract from the quickstart template, validate against the 0.7.2 schema, preview the plan, and apply against the local DuckDB provider. The walkthrough below covers the same flow with hands-on contract editing in the middle."
  width="920"
