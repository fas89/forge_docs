...
This page is the changelog for the staged data-model V1.5 + V2
release (schema 0.7.3) in the forge-cli repo. It covers V1.5
(catalog integration) and the V2 polish items shipped alongside.
This is a next-release surface — not in the 0.8.0 baseline yet.

> **Audience:** anyone reviewing this release, anyone planning to
...
Full sweep result for this release as of this writing:
